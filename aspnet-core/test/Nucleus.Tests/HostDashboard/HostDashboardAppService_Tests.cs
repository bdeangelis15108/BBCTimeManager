...
using Nucleus.MultiTenancy.HostDashboard;
...
namespace Nucleus.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(NucleusDbContext context, SubscriptionPayment subscriptionPayment)
        {
