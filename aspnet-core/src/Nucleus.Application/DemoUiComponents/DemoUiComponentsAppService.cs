...
using Nucleus.DemoUiComponents.Dto;

namespace Nucleus.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : NucleusAppServiceBase, IDemoUiComponentsAppService
    {
