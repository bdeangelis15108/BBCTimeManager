...
{
    public class SessionAppService : NucleusAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = NucleusConsts.Currency,
                    CurrencySign = NucleusConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = NucleusConsts.AllowTenantsToChangeEmailSettings
                }
            };
