...
using Nucleus.Auditing.Exporting;
using Nucleus.Authorization;
using Nucleus.Authorization.Users;
using Nucleus.Dto;
using Nucleus.EntityHistory;
using EntityHistoryHelper = Nucleus.EntityHistory.EntityHistoryHelper;

namespace Nucleus.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : NucleusAppServiceBase, IAuditLogAppService
    {
