...
using Nucleus.Migrations.Seed;
using Nucleus.Migrations.Seed.Host;
...
namespace Nucleus.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : NucleusAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<NucleusDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(NucleusConsts.ConnectionStringName).Value.ToString();
        }
