...
{
    public class AbpLoginResultTypeHelper : NucleusServiceBase, ITransientDependency
    {
        public Exception CreateExceptionForFailedLoginAttempt(AbpLoginResultType result, string usernameOrEmailAddress, string tenancyName, string reason = "")
        {
            switch (result)
            {
                ...
                case AbpLoginResultType.UserIsNotActive:
                    ...
                    {
                        return new UserFriendlyException(L("LoginFailed"), reason);
                    }
