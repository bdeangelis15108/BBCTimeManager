...
using Nucleus.Authorization.Users.Exporting;
using Nucleus.Dto;
...
namespace Nucleus.Authorization.Users
{
    ...
    public class UserAppService : NucleusAppServiceBase, IUserAppService
    {
        ...
        public async Task<GetUserForEditOutput> GetUserForEdit(NullableIdDto<long> input)
        {
            ...
            else
            {
                ...
                output.User.WorkerClaseesesId = user.WorkerClaseesesId;
        ...
        protected virtual async Task UpdateUserAsync(CreateOrUpdateUserInput input)
        {
            ...
            user.WorkerClaseesesId = input.User.WorkerClaseesesId;
        ...
        protected virtual async Task CreateUserAsync(CreateOrUpdateUserInput input)
        {
            ...
            var workerId = input.User.workerClaseesId;
            // input.User.workerClaseesId = null;
            // input.User.WorkerClaseesesId = null;
            User user = new User
            {
                WorkerClaseesesId = input.User.WorkerClaseesesId,
                ...
                IsLockoutEnabled = false//input.User.IsLockoutEnabled
            };
            // user = ObjectMapper.Map<User>(input.User); //Passwords is not mapped (see mapping configuration)
            user.TenantId = AbpSession.TenantId;
            // user.WorkerClaseesesId = workerId;
            //Set password
            ...
            //user.ShouldChangePasswordOnNextLogin = false;// input.User.ShouldChangePasswordOnNextLogin;
