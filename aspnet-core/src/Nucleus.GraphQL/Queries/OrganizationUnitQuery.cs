...
using Nucleus.Core.Base;
using Nucleus.Core.Extensions;
using Nucleus.Dto;
using Nucleus.Types;

namespace Nucleus.Queries
{
    public class OrganizationUnitQuery : NucleusQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
