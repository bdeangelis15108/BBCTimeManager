...
namespace Nucleus.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : NucleusServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Nucleus", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
