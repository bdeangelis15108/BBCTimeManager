...
{
    public class StripeGatewayManager : NucleusServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Nucleus";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + NucleusConsts.Currency;
        }
