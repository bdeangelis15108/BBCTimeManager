...
namespace Nucleus.Web.Startup
{
    ...
    public class NucleusWebHostModule : AbpModule
    {
        ...
        public NucleusWebHostModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        {
            Configuration.Modules.AbpWebCommon().MultiTenancy.DomainFormat = _appConfiguration["App:ServerRootAddress"] ?? "https://bbc.threepointturn.com/api/ ";
