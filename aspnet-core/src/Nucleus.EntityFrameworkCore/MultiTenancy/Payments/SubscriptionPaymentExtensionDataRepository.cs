...
using Nucleus.EntityFrameworkCore.Repositories;

namespace Nucleus.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : NucleusRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<NucleusDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
