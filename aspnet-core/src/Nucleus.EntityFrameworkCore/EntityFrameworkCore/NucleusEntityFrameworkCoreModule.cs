...
namespace Nucleus.EntityFrameworkCore
{
    ...
    public class NucleusEntityFrameworkCoreModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            ...
            // Configuration.EntityHistory.Selectors.Add("NucleusEntities", EntityHistoryHelper.TrackedTypes);
            // Configuration.CustomConfigProviders.Add(new EntityHistoryConfigProvider(Configuration));
        }

        public override void Initialize()
        {
            IocManager.RegisterAssemblyByConvention(typeof(NucleusEntityFrameworkCoreModule).GetAssembly());
        }
