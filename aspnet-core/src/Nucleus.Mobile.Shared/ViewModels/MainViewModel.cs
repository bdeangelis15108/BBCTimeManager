...
using MvvmHelpers;
using Nucleus.Authorization.Users.Profile;
...
using Nucleus.Controls;
using Nucleus.Dto;
using Nucleus.Extensions;
using Nucleus.Localization;
using Nucleus.UI;
using Nucleus.UI.Assets;
using Nucleus.Views;
using DependencyResolver = Nucleus.Core.Dependency.DependencyResolver;
...
namespace Nucleus.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Nucleus";
        ...
        private void ChangeProfilePhoto()
        {
            UserDialogs.Instance.ActionSheet(new ActionSheetConfig
            {
                ...
                Options = new List<ActionSheetOption>  {
                    ...
                    new ActionSheetOption(L.Localize("Cancel"),null)
                }
            });
        }
