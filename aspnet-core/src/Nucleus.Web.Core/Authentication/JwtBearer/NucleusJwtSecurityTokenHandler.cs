...
namespace Nucleus.Web.Authentication.JwtBearer
{
    public class NucleusJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public NucleusJwtSecurityTokenHandler()
        {
