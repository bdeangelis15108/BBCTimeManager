...
using Nucleus.Web.Configuration;
using Nucleus.Web.DashboardCustomization;
...
namespace Nucleus.Web
{
    ...
    public class NucleusWebCoreModule : AbpModule
    {
        ...
        public NucleusWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(NucleusWebCoreModule).Assembly);
        }
