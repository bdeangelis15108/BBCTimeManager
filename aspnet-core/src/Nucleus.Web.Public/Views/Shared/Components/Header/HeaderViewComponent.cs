...
using Nucleus.Url;
using Nucleus.Web.Public.Startup;
using Nucleus.Web.Session;

namespace Nucleus.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : NucleusViewComponent
    {
