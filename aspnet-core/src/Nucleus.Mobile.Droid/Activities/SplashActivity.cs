...
using Nucleus.Core;
using Nucleus.Localization.Resources;
using Nucleus.ViewModels.Base;
using Plugin.Connectivity;
using Process = Android.OS.Process;

namespace Nucleus.Activities
{
    ...
    public class SplashActivity : AppCompatActivity
    {
        ...
        {
            base.OnResume();
            ApplicationBootstrapper.InitializeIfNeeds<NucleusXamarinAndroidModule>();
            Barrel.ApplicationId = "BBC";
